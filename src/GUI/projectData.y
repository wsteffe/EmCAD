...
%token IDEAL CANONICAL FILTER CUSTOM PASS STOP KRYLOV ORDER RETURNLOSS OUTBAND MAPPING TUNING METHOD SOURCE ITERMAX AUTOMATIC DESIGN WITH MAPPED TX ZEROS
...
Mesh:
         ...
         | CONFORMAL MESH INTEGER
            {
              prjData.conformalMeshIF=$3;
            }
...
FilterDesign:
        ...
        |  FILTER STOP BAND SFFloat SFFloat
            {
              prjData.filterStopBand[0]=$4;
              prjData.filterStopBand[1]=$5;
            }
