...
%token MWM_MATERIAL TEMPORTSNUM TEPORTSNUM TMPORTSNUM TEMTABULARORDER1 TEMTABULARORDER2 TEMREFCONDUCTOR
%token DISCONNECTEDTEM SUBCIRCUITINDEX SUBCIRCUITIFINDEX  ORIENTATION
...
VolumeElement
	...
	|  SUBCIRCUITINDEX	{Ibuff  =NULL;}       SFInt32
                {
                  vol->subcircuitIndex =$3;
                }
	|  SUBCIRCUITIFINDEX	{Ibuff  =NULL;}       SFInt32
                {
                  vol->subcircuitIFindex =$3;
                }
